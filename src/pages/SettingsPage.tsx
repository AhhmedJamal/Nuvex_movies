...
function SettingsPage() {
  ...
  return (
    <section className="flex flex-col justify-evenly items-center h-[85%] gap-4 p-4">
      ...
      <div className="flex flex-col items-center gap-3 justify-center">
        ...
        <div className="flex items-center justify-between  bg-neutral-300 dark:bg-neutral-800 px-3  font-bold rounded-md">
          {userData?.displayName ? userData?.displayName : "Hi Guest"}
        </div>
      </div>
      <div className=" w-[90%] md:w-[50%] flex flex-col gap-3">
        <div className="flex items-center justify-between gap-4 bg-neutral-300 dark:bg-neutral-800 p-3  font-bold rounded-xl active:bg-[#3333334d]">
          ...
          <div
            onClick={toggleTheme}
            className={`w-11 h-6 transition-all cursor-pointer ${
        ...
        <div className="flex items-center justify-between gap-4 cursor-pointer bg-neutral-300 dark:bg-neutral-800 p-3  font-bold rounded-xl active:bg-[#3333334d]">
        ...
        <div
          ...
          className="flex items-center gap-3 bg-neutral-300 dark:bg-neutral-800 p-3 cursor-pointer font-bold rounded-xl active:bg-[#3333334d]"
        >
          <IoIosLogOut size={20} />
          {userData.email ? " Exit" : "Register OR Login"}
        </div>
        {userData.email && (
          <div
            onClick={handleDeleteUser}
            className="flex items-center justify-center gap-3 bg-primary p-3 text-white mt-9 font-bold rounded-xl active:bg-[#ffce3de0] "
          >
            <MdDelete size={20} />
            Delete Account
          </div>
