        ...
        <div className="flex flex-col-reverse sm:flex-row gap-2  justify-between items-center ">
          <div className="flex w-full gap-3">
            ...
            <Link
              ...
              target="_blank"
              className="bg-neutral-800 dark:bg-neutral-200 text-neutral-200 dark:text-neutral-800 active:bg-neutral-600 dark:active:bg-neutral-400  transition-all w-[50%] flex justify-center items-center gap-2 py-2 rounded-md text-[13px] font-bold"
            >
          ...
          <button
            onClick={handleClickShowMovie}
            className="bg-primary text-neutral-200 dark:text-neutral-900 active:bg-[#f39e0be0] transition-all w-full flex justify-center items-center gap-2 py-2 rounded-md text-[15px] font-bold"
          >
            <FaPlay size={17} />
            Play
          </button>
