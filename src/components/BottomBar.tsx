  ...
  return (
    <footer
      className={`${
        ...
        pathname !== "/settings" &&
        "hidden"
      } sm:hidden z-10 fixed bottom-[0px]  w-full  h-[70px]  flex justify-around items-center bg-neutral-100 dark:bg-neutral-950  border-t border-zinc-200 dark:border-zinc-800 transition-all`}
    >
